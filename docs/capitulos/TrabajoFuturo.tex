...
\begin{enumerate}
    ...
    \item Evaluar el escalado horizontal de los ejecutores de Spark Structured Streaming y de las particiones de Kafka bajo carga variable, midiendo consumo de CPU, memoria y latencia, replicando la metodología de estudios recientes que han comparado el rendimiento y la eficiencia de recursos de varias distribuciones ligeras de Kubernetes en escenarios de edge computing bajo esas mismas métricas \cite{koziolek2023} y de trabajos que han evaluado herramientas de orquestación de contenedores específicamente en dichos entornos \cite{cilic2023}.
