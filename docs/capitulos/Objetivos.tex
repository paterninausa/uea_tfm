...
\textbf{KPI}: cada micro-lote de Spark Structured Streaming se procesa en menos de 2 segundos sin acumular retraso entre micro-lotes sucesivos.

\textbf{Acciones}: implementar el proceso de Spark Structured Streaming (DataFrame API) con ventanas de agregación temporal y \textit{watermarking} para el tratamiento de datos tardíos; medir la máxima duración de procesamiento de cada consulta a Kafka.
