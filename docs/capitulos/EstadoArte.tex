...
\subsection{El crecimiento exponencial de datos IoT y el Big Data}

La explosión en el volumen, velocidad y variedad de los datos generados por miles de millones de dispositivos ha superado la capacidad de los enfoques de procesamiento tradicionales, obligando a la creación y adopción de arquitecturas capaces de ingerir, procesar y almacenar flujos continuos de datos en tiempo real. Por tanto, el rápido crecimiento en el número de dispositivos conectados al Internet de las Cosas (IoT) y el aumento exponencial en el uso de datos sugieren claramente que el desarrollo del Big Data está estrechamente vinculado con el IoT (Y. Liu \cite{liu2025}).
