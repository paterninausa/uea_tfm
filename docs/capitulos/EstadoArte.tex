...
El ecosistema de herramientas de código abierto disponibles para cada etapa del pipeline IoT ha madurado considerablemente, como ilustran las implementaciones de S. Shinde \cite{shinde2025} y G. Zefkilis \cite{zefkilis2025} comentadas en la sección anterior.

En la etapa de ingesta, los protocolos ligeros de publicación-suscripción como MQTT conviven con brokers que ofrecen puentes nativos hacia sistemas de mensajería distribuida como Apache Kafka, permitiendo desacoplar la capa de dispositivos de la capa de procesamiento.
...
En el desarrollo del trabajo se utilizará un conjunto de datos de telemetría de consumo eléctrico como caso de estudio, evaluando la viabilidad técnica de la arquitectura y dejando como artefacto reutilizable el código, la configuración de despliegue y la documentación asociada.