...
De la revisión anterior se desprende que, si bien existen múltiples implementaciones ilustrativas de arquitecturas Kappa aplicadas a IoT, y sistemas equivalentes de gobernanza de esquemas y doble sumidero documentados en contextos de streaming de propósito general, ninguna implementación Kappa-IoT open-source revisada combina simultáneamente (i) un broker MQTT ligero y acoplado a un microservicio de bridging dedicado hacia Kafka; (ii) un registro de esquemas Avro que valide el formato de cada evento transmitido y su admisibilidad entre la capa de ingesta y la capa de procesamiento; y (iii) una estrategia de doble sumidero que separe el consumo de datos operacionales en tiempo real del consumo analítico.
