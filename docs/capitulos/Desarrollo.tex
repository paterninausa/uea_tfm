...
Una decisión de implementación relevante en el script es que \texttt{building\_id} se trata como texto en el pipeline, pese a ser en el dateset de origen un identificador numérico:
