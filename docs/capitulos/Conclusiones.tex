...
\begin{enumerate}
  \item \textbf{Persistencia de telemetría rápida y fiable.} El p95 de la telemetría validada se persistió en un tiempo inferior a los 25~segundos, con 0~\% de mensajes perdidos durante el procesamiento.
  \item \textbf{Gobernanza del esquema de datos.} El 100~\% de los eventos ingeridos se validaron contra el esquema Avro registrado, sin fallos de deserialización ni mensajes erróneamente desviados al tópico de inválidos.
