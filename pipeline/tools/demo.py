...
def _resumen(args: argparse.Namespace, eta_min: float) -> None:
    ...
    print("=" * 68)
    print(f"  Grafana:   {GRAFANA_URL}   (usuario: admin  contrasena: admin)")
    print("  Dashboards (menu ☰ -> Dashboards):")
    print("    1. Estado del pipeline   -> rango 'now-15m' (ingesta en vivo)")
    print(f"    2. Consumo energetico    -> pon el rango a '{rango}' o 'Last 3 months'")
    print(f"    3. Calidad y anomalias   -> idem '{rango}'")
    print()
